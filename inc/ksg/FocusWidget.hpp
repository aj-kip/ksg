...
class FocusWidgetAtt {
    friend class ksg::detail::FrameFocusHandler;
...
public:
     ...
     */
    virtual void process_focus_event(const sf::Event &) = 0;
...
class FrameFocusHandler {
public:
    using FocusChangeFunc = std::function<bool(const sf::Event &)>;
     ...
     */
    static bool default_focus_advance(const sf::Event &);
     ...
     */
    static bool default_focus_regress(const sf::Event &);
